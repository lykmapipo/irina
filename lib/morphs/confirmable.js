 ...
 * @param {Object} options valid confirmable plugin options
 * @see {@link http://www.rubydoc.info/github/plataformatec/devise/master/Devise/Models/Confirmable|Confirmable}
 * @public
 */
module.exports = exports = function Confirmable(schema, optns) {
  ...
  schema.methods.confirm = function (done) {
    ...
    .waterfall([
        ...
        function (confirmable, next) {
          ...
          if (!tokenizer.match(confirmable.confirmationToken, confirmable
              .email)) {
