 ...
 * @constructor
 *
 * @description Confirmable is responsible to verify if an authentication is
...
module.exports = exports = function Confirmable(schema, options) {
     ...
     * @function
     *
     * @description send confirmation notification to allow authentication 
     *              to be confirmed.
     ...
     * @callback confirm~callback
     * @param {Object} error any error encountered during authentication confirmation
