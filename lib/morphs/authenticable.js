...
module.exports = exports = function Authenticable(schema, options) {
    ...
    authenticationFields[options.authenticationField] = {
        ...
        trim: true,
        //add mongoose-valid8 validations
        isRequired: {
            message: options.authenticationField + ' is required'
        },
    };
    ...
    authenticationFields[options.passwordField] = {
        ...
        //add mongoose-valid8 validations
        isRequired: {
            message: options.passwordField + ' is required'
        },
                        ...
                        authenticable
                            .lock(function(error /*, authenticable*/ ) {
                                if (error) {
                                    ...
                                    done(new Error('Account locked. Check for unlock instructions sent to you.'));
                                }
                            });
        ...
        async
            .waterfall(
                [
                    ...
                    //
                    //TODO allow custom criteria to be passed
                    function(next) {
                        var criteria = {};
